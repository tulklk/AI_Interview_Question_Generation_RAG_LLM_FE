...
/** Landing pricing: job seekers & interview prep (Free + Premium). */
export const pricingPlansJobSeeker: PricingPlan[] = [
  {
    ...
    price: "$0",
    period: "/ month",
    description: "Explore interview practice with AI feedback — no credit card needed.",
    highlighted: false,
    cta: "Get Started Free",
    features: [
      { text: "5 practice sessions per month", included: true },
      { text: "3 questions visible per set", included: true },
      { text: "Basic AI feedback score", included: true },
      { text: "10 sessions practice history", included: true },
      { text: "Community support", included: true },
      { text: "Full question set access", included: false },
      { text: "Advanced AI evaluation & feedback", included: false },
      { text: "Unlimited sessions & history", included: false },
      { text: "Send scorecard directly to HR", included: false },
    ],
  },
  {
    id: "premium",
    ...
    features: [
      { text: "Full access to all question sets", included: true },
      { text: "Unlimited practice sessions", included: true },
      { text: "Advanced AI evaluation & feedback", included: true },
      { text: "Unlimited practice history", included: true },
      { text: "Send scorecard directly to HR", included: true },
      { text: "Priority support", included: true },
      { text: "Save 36% with yearly billing ($99/yr)", included: true },
    ],
  },
];
