        ...
        {isInView ? (
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={weeklyUsageData} margin={{ top: 4, right: 8, bottom: 0, left: -12 }}>
              ...
              />
              <Line type="monotone" dataKey="users" name={w.usersLegend} stroke="#6c47ff" strokeWidth={2.5} dot={false} activeDot={{ r: 4, fill: "#6c47ff" }} />
              <Line type="monotone" dataKey="submissions" name={w.jdLegend} stroke="#a78bfa" strokeWidth={2.5} dot={false} activeDot={{ r: 4, fill: "#a78bfa" }} />
            </LineChart>
          </ResponsiveContainer>
        ) : (
