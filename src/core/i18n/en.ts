...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
  ...
  hrRecommendationsPage: {
    ...
    invite: {
      ...
      defaultMessage: "Hi {{name}}, we were impressed by your results on \"{{title}}\" ({{score}}/100) and would like to invite you for an interview. Please reply with your email or phone number so we can reach out. Thank you!",
