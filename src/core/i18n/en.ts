...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
  ...
  jobseekerDashboardPage: {
    ...
    analyticsUnavailable: "Per-skill performance charts aren't available yet.",
    skillBreakdownTitle: "Skill Breakdown",
    skillBreakdownUnavailable: "A strengths/weaknesses breakdown per skill isn't available yet — check your session history for per-session scores in the meantime.",
    aiRecommendationTitle: "AI Recommendation",
    aiRecommendationEmpty: "Complete your first practice session to start getting tips here.",
    aiRecommendationTemplate: "You've completed {{count}} sessions with a {{avg}}% average score. Keep practicing to push your interview readiness higher.",
    aiRecommendationNoScore: "You've completed {{count}} sessions. Keep practicing to build your interview readiness.",
