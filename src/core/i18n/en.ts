...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
  ...
  publishedInsightsPage: {
    ...
    subtext: "Overview of your published sets — attempts, scores, and candidate feedback.",
    ...
    settings: {
      ...
      antiCheatSection: "Anti-cheat",
        ...
        antiCheatEnabledHint:
          "Applies to new practice sessions: count tab leaves, no timer pause, disable Save & Exit. In-progress sessions keep their old rules.",
  ...
  jobseekerCoachPage: {
    ...
    marketplaceLinkDesc: "Practice company-published sets.",
  ...
  jobseekerPracticePage: {
    ...
    antiCheatBanner: "Anti-cheat is on — Pause / Save & Exit are disabled.",
    coachModeBanner:
    ...
    antiCheatExitMessage:
      "Anti-cheat is enabled for this session. The timer does not pause and Save & Exit is disabled. Continue answering or submit.",
