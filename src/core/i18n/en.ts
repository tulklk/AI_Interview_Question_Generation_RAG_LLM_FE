...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
  ...
  settingsPage: {
    ...
    subscription: {
      ...
      orderCreatedToast: "Payment order created. Please transfer using the exact reference content.",
  ...
  studioPage: {
    ...
    toasts: {
      ...
      publishNotFound: "No question set found to publish. Try saving as draft first.",
