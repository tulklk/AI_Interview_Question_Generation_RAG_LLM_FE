export const en = {
  common: {
    ...
    pickDate: "Pick a specific date",
    pickAnalysisDate: "Pick analysis date",
    clearSelectedDate: "Clear selected date",
    rotateHint: "Drag to rotate 360°, scroll to zoom",
    questionImageAlt: "Question attachment",
    whyAskedPlaceholder: "Why this question is asked (excluding template/snippet meta)",
  ...
  benefits: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Download Excel instantly and share with teammates.",
      },
    ],
  },
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Review past sessions and export to Excel anytime.",
      },
    ],
  },
  ...
  pricing: {
    ...
    ctaNotApplicable: "Not available for this account",
    ctaAlreadyHaveAccount: "You already have an account",
    jobSeeker: {
    ...
    recruiter: {
      ...
      subtext: "Generate question sets from JD with AI + RAG. Free: 1 set / 24h + 2 regens / set. Premium: unlimited.",
      valueMessage: "",
      highlights: [
      ...
      upgradeWhy: {
        ...
        footnote: "Ask-AI and export are Premium because they consume LLM quota. Free: 1 completed set / 24h, 2 question regens / set.",
        points: [
          {
          ...
          },
          {
            ...
            body: "≤ 5 plan regenerations per draft on both tiers. Free: ≤ 2 question regens per set.",
          },
          {
      ...
      plans: [
        {
          name: "Free",
          period: "/ month",
          description: "Complete 1 set / 24h — Marketplace publish included.",
          cta: "Start Free",
          features: [
            "Studio: plan & generate from JD",
            "Complete 1 set / 24-hour cooldown",
            "Question regen ≤ 2 times per set",
  ...
  resetPasswordPage: {
    ...
    passwordComplexity: "Password must contain at least 1 uppercase, 1 lowercase, 1 number and 1 special character.",
  ...
  registerJobSeekerPage: {
    ...
    seniorityRequired: "Please select an experience level.",
    techStackRequired: "Select at least one technology.",
...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
    ...
    quota: {
      exceededTitle: "Question set / JD review limit reached (24h)",
      exceededBody:
        "Free plan allows completing 1 question set or JD review per 24 hours. Try again after {{time}}, or upgrade to Premium. After questions exist you can still regenerate up to 2 times per set.",
  ...
  manualPage: {
    ...
    bulkBar: {
      ...
      countLabel: "Count",
      createBtn: "Create",
      toast: "Created {{count}} empty questions.",
      pasteHint: "Tip: paste multiple lines into a question field to split into several questions.",
    },
    cloneMenu: {
      cloneOne: "Duplicate once",
      cloneNEmpty: "Duplicate N empty",
      countLabel: "Copies",
      confirm: "Duplicate",
      cancel: "Cancel",
      dialogTitle: "Duplicate N empty copies",
      dialogDesc: "Keep type and difficulty; leave content blank for you to fill in.",
      toastOne: "Question duplicated.",
      toastN: "Created {{count}} empty copies.",
    },
    paste: {
      toast: "Added {{count}} questions from pasted text.",
    },
    actions: {
  ...
  knowledgePage: {
    ...
    typeRequired: "Select a document type before uploading.",
    typeUpdated: "Document type updated.",
    typeUpdateFailed: "Could not update document type.",
    changeType: "Change type",
    chunksPreview: "Chunk preview",
    noChunks: "No chunks yet or ingest not finished.",
    ingestFailedTitle: "Ingest failed",
    ingestFailedNoChunks: "No chunks because ingest failed — see the reason above.",
    ingestErrorUnknown: "No error detail from the system. Try «Re-process» or check the document format/content.",
    inProjects: "{{n}} projects",
    citedTimes: "{{n}} citations",
    documentTypes: {
      Policy: "Policy",
    ...
    adminNotePlaceholder: "Internal note for this system document...",
    uploadNoteLabel: "Document note",
    uploadNotePlaceholder: "e.g. Seed SWE-QA flask — 48 Q/A Python web framework",
    uploadNoteHint: "Attach a note to the file you upload (shown in the list; editable in the drawer).",
    uploadFolderLabel: "Folder / group",
    uploadFolderPlaceholder: "e.g. test-candidate, swe, dotnet-junior",
    uploadFolderHint:
      "Assign a folder to group files. Folder test-candidate is used by Coach question generation (RAG retrieves only docs in that folder).",
    coachKbFolderBanner:
      "Coach question generation reads only SYSTEM folder «test-candidate». Upload files (type InternalStack), set folder test-candidate, wait until Status=Completed.",
    coachKbFolderBannerCta: "Point upload form → test-candidate",
    ...
    coachRoadmapFolderBanner:
      "Coach roadmap RAG reads SYSTEM folder «coach-roadmap». Upload type Roadmap, set folder coach-roadmap, wait until Completed.",
    coachRoadmapFolderBannerCta: "Point upload form → coach-roadmap",
    coachRoadmapFolderUsePreset: "Coach roadmap (coach-roadmap)",
    coachKbFolderQuickPick: "Quick-pick folder",
    coachKbFolderUsePreset: "Coach (test-candidate)",
    coachKbFolderSelectHint: "Pick an existing folder or type a new name below.",
    coachKbFolderCustomLabel: "Or type / edit folder name",
    ...
    moveConfirm: "Move",
    moveFolderHint: "Leave empty for unsorted. UI metadata only (Blob path unchanged).",
    moveSuccess: "Moved {{n}} file(s).",
    moveFailed: "Could not move to folder.",
    renameFolder: "Rename folder",
    renameFolderFrom: "From: {{name}}",
    renameConfirm: "Rename",
    renameSuccess: "Renamed · {{n}} file(s).",
    renameFailed: "Could not rename folder.",
    saveAdminNote: "Save note",
    adminNoteSaved: "Admin note saved.",
    adminNoteSaveFailed: "Could not save admin note.",
    pathLabel: "Path",
    statusLabel: "Status",
  },
  ...
  historyPage: {
    ...
    subtext: "Question sets saved from Studio — including drafts and published sets.",
    ...
    feedbackTitle: "View candidate feedback",
    ...
    filters: {
      ...
      scoreAll: "Score: All",
      scoreFairPlus: "Score: Fair & above",
      scoreGoodPlus: "Score: Good & above",
      scoreExcellentPlus: "Score: Excellent",
  ...
  publishDialog: {
    ...
    selectedCount: "{{selected}} selected (min {{min}})",
    ...
    timeLimitDescription: "Candidates are auto-submitted when time runs out.",
    noLimitLabel: "No time limit",
    minutesLabel: "Time limit",
    limitModeLabel: "Time limit",
    minutesUnit: "min",
    rangeError: "Enter a number between 1 and 480.",
    recommendTitle: "Recommend candidates",
    recommendDescription:
      "Candidates who score high enough appear in your recommendations list.",
    recommendEnable: "Auto-recommend candidates",
    recommendMinScore: "Minimum score (50–95)",
    recommendScoreError: "Enter a score between 50 and 95.",
    recommendScoreDisabledHint: "Turn on candidate recommendations to configure the score threshold.",
    recommendOn: "On",
    recommendOff: "Off",
    hiringModeTitle: "Set purpose",
    summaryTitle: "Summary",
    footerReady: "{{count}} questions will be published",
    cancelBtn: "Cancel",
    confirmBtn: "Publish",
    confirmWithCount: "Publish {{count}} questions",
  ...
  hiringMode: {
    ...
    antiCheatOn: "AC on",
    antiCheatOff: "AC off",
    antiCheatLocked: "AC locked",
    antiCheatOnHint: "Anti-cheat is on for new sessions on this Hiring set.",
    antiCheatOffHint: "Anti-cheat is off — click to enable (requires Admin platform ON).",
    adminOffHint: "Admin turned off platform anti-cheat — toggle is locked.",
    practiceHint: "Marketplace practice as today — no public JD, no anti-cheat.",
    hiringHint:
      "Show JD to candidates. First completed attempt is the official test for HR history; later attempts are private practice.",
    officialTestBadge: "Official test",
    hiringBadge: "Hiring",
    publicJdTitle: "JD shown to candidates",
    publicJdHint:
      "Short summary for candidates on Hiring sets. Does not change the full JD used for generation.",
    publicJdPlaceholder: "Write a short job summary for candidates…",
    publicJdCopyFromSource: "Copy from full JD",
    publicJdSave: "Save public JD",
    publicJdSaveSuccess: "Public JD saved.",
    publicJdSaveFailed: "Could not save public JD.",
    publicJdRequired: "Enter a short public JD before enabling Hiring / publish.",
    publicJdNoSource: "No full JD to copy.",
    publicJdFileFallback: "Attached JD file",
    publicJdDownload: "Download",
    publicJdOpenImage: "Open image",
    postingSectionTitle: "Job posting details",
    postingLocation: "Location",
    postingLocationPlaceholder: "e.g. Da Nang, Ho Chi Minh City",
    postingLocationRequired: "Enter a work location.",
    postingWorkplace: "Workplace",
    postingWorkplaceOptional: "— Optional —",
    postingWorkplaceAtOffice: "At office",
    postingWorkplaceHybrid: "Hybrid",
    postingWorkplaceRemote: "Remote",
    postingExpertise: "Job expertise",
    postingExpertisePlaceholder: "e.g. Backend Developer",
    postingExpertiseRequired: "Enter job expertise.",
    postingDomain: "Job domain",
    postingDomainPlaceholder: "e.g. IT Services",
    postingDomainRequired: "Enter job domain.",
    postingSalaryNegotiable: "Salary negotiable",
    postingSalaryMin: "Min salary (VND)",
    postingSalaryMax: "Max salary (VND)",
    postingSalaryRequired: "Enter a salary range or mark as negotiable.",
    postingSalaryRangeInvalid: "Max salary must be ≥ min salary.",
    postingIncomplete: "Need public JD + location, expertise, domain and salary before Hiring.",
    postingSave: "Save posting",
    candidateJdSub: "Summary from the recruiter",
    candidateJdExpand: "Show more",
    candidateJdCollapse: "Show less",
    candidateJdTitle: "Job description",
  },

  hiringJobsPage: {
    heading: "Jobs",
    subheading: "Hiring assessments published by recruiters",
    searchPlaceholder: "Search by role, company, JD…",
    emptyTitle: "No open roles yet",
    emptyBody: "When HR publishes a hiring set, it will show up here.",
    ...
    interviewPlanSub: "Skill groups you will be asked about — question text stays hidden.",
    backToJobs: "Back to jobs",
    companyCardTitle: "Company",
    bookmark: "Save",
    bookmarked: "Saved",
    attempts: "{{count}} attempts",
    loadError: "Could not load jobs. Try again.",
    retry: "Retry",
    ...
    salaryLabel: "Salary",
    workplaceAtOffice: "At office",
    workplaceHybrid: "Hybrid",
    workplaceRemote: "Remote",
    skillsLabel: "Skills",
    expertiseLabel: "Job expertise",
    domainLabel: "Job domain",
    selectJobHint: "Select a role on the left to see details",
    openFullPage: "Open full page",
    listTitle: "Jobs",
    listCount: "{{count}} roles",
    positionInfo: "Role info",
    bookmarkSave: "Save job",
    bookmarkSaved: "Saved",
    emptySearchTitle: "No matching roles",
    emptySearchBody: "Try a different search keyword.",
    emptyFilterBody: "Try changing or clearing some filters.",
    filterUrgent: "Urgent",
    filterWorkplace: "Work mode",
    filterSalary: "Salary",
    ...
    filterDifficulty: "Assessment difficulty",
    filterDuration: "Assessment duration",
    filterAdvanced: "Filters",
    filterSearchExpertise: "Search expertise",
    filterSearchSkills: "Search skills",
    filterSearchDomain: "Search domain",
    filterSearchLocation: "Search location",
    filterSearchCompany: "Search company",
    filterSalaryFrom: "From",
    filterSalaryTo: "To",
    filterSalaryApply: "Apply",
    filterSalaryReset: "Reset",
    filterNumericSalaryOnly: "Numeric salary only",
    filterClearAll: "Clear all",
    filterFiltering: "Filtering:",
    filterDifficultyEasy: "Easy",
    filterDifficultyMedium: "Medium",
    filterDifficultyHard: "Hard",
    filterDurationMax: "Up to {{min}} min",
    filterDurationAny: "Any duration",
    filterNoOptions: "No options",
    filterViewResults: "View {{count}} roles",
  },

  publishedInsightsPage: {
    heading: "Practice & ratings",
    subtext: "Overview of published sets — Hiring (applicants) and Practice (attempts).",
    emptyTitle: "No published sets yet",
    emptyBody: "Publish a question set to see practice and rating insights here.",
    filterAll: "All",
    filterHiring: "Hiring",
    filterPractice: "Practice",
    hiringBadge: "Hiring",
    sectionHiringTitle: "Hiring",
    sectionHiringSub: "Assessment sets — see who took the official test.",
    sectionPracticeTitle: "Practice",
    sectionPracticeSub: "Marketplace practice sets — track attempts and scores.",
    sectionEmptyHiring: "No published hiring sets yet.",
    sectionEmptyPractice: "No published practice sets yet.",
    colStatus: "Status",
    statusOnJobs: "Open hiring",
    statusOnMarketplace: "On marketplace",
    colTitle: "Title",
    ...
    retry: "Retry",
    emptyFilter: "No sets match this filter.",
  },
  ...
  publishedHubPage: {
    ...
    statusPublishedHiring: "Open hiring",
    statusDraft: "Draft",
    liveCount: "{{live}} live / {{total}} questions",
    noTimeLimit: "No time limit",
    timeLimit: "{{n}} min",
    recommendOn: "Recommend ≥{{score}}",
    recommendOff: "Recommend off",
    openReview: "Open in Review",
    unpublish: "Unpublish",
    unpublishSuccess: "Question set unpublished.",
    unpublishSuccessHiring: "Hiring set removed from Jobs.",
    actionFailed: "Action failed. Please try again.",
    notPublishedBanner: "This set is not published. You can still inspect it, or open Review:",
    loadFailed: "Failed to load this question set.",
    retry: "Retry",
    tabOverview: "Overview",
    tabQuestions: "Live questions",
    ...
    metricApplicantsSub: "{{done}} completed · {{progress}} in progress",
    metricAvgScore: "Avg score",
    metricAvgScoreSub: "Completed sessions",
    metricRating: "Avg rating",
    metricLiveQuestions: "Live questions",
    recentPractitioners: "Recent practitioners",
    recentApplicants: "Recent applicants",
    recentFeedback: "Recent feedback",
    viewAll: "View all",
    showPracticeToggle: "Show practice attempts too",
    showPracticeHint: "Include later practice runs after the official test.",
    practiceOnlyBadge: "Practice",
    inviteSuccessOfferCta: "Invite sent. Open the recommendation to send an Offer.",
    openRecommendationOffer: "Open recommendation / Offer",
    badgeLive: "On marketplace",
    badgeLiveHiring: "On Jobs",
    badgeHidden: "Not published",
    ...
    feedbackEmptyBody: "Candidates have not rated this set yet.",
    feedbackCount: "{{n}} ratings",
  },
  ...
  settingsPage: {
    ...
    profile: {
      ...
      recPrefsTitle: "Potential candidates display",
      recPrefsHint: "Defaults when opening Potential Candidates. You can still change filters in-session.",
      recDefaultMinScore: "Default minimum score",
      recNoMinScore: "No score filter",
      recDefaultSort: "Default sort",
      recDefaultSortDir: "Sort direction",
      recSortScore: "By score",
      recSortDate: "By date",
      recSortDesc: "Descending",
      recSortAsc: "Ascending",
      recHideDismissed: "Hide dismissed candidates from All tab",
      recYes: "Yes",
      recNo: "No",
      ...
      sectionConnected: "Connected accounts",
      sectionRecruitment: "Recruitment preferences",
      editProfileBtn: "Edit profile",
      premiumBadge: "Premium",
      defaultRole: "HR",
      googleNotLinked: "No account linked yet.",
      completeness: "Profile {{percent}}% complete",
      completenessHint: "Fill in the missing details to strengthen your profile.",
    },
    preferences: {
      title: "Preferences",
    ...
    subscription: {
      ...
      planCardRows: {
        HR_FREE: [
          ...
          { text: "Generate 1 completed set per 24-hour cooldown", included: true },
          { text: "Question regen up to 2 times per set", included: true },
      ...
      included: "Included",
      notIncluded: "—",
      limitsNote: "When an admin updates plan limits, Active subscribers get the new limits immediately; usage already consumed is kept.",
      usage: {
        title: "Usage this period",
        subtitle: "AI runs you have already consumed in the current period, updated after every run.",
        period: "Period",
        refresh: "Refresh",
      ...
      paymentHistory: {
        ...
        exportInvoiceFailed: "Could not open the print window. Allow popups and try again.",
        invoiceDocTitle: "Payment invoice",
        invoiceBrand: "IQGS",
        invoicePaidTitle: "Invoice paid",
        invoicePaymentMethod: "Payment method",
        invoicePaymentDate: "Payment date",
        invoiceNumberLabel: "Invoice number",
        invoicePoweredBy: "Powered by IQGS",
        invoiceFootnote: "Electronic receipt. In the print dialog, choose Save as PDF.",
      },
    },
  },

  hrSubscription: {
    quotaExceededTitle: "Question set / JD review limit reached (24h)",
    quotaExceededBody:
      "Free plan allows <strong>1 completed question set or JD review per 24 hours</strong>. You can try again after <strong>{{time}}</strong>, or upgrade to Premium. Question regen: up to <strong>2 times per set</strong>.",
  ...
  chatWidget: {
    ...
    responses: {
      ...
      export:
        "Yes! All generated question sets can be exported to a clean, formatted Excel file — ready to use in your interview panel.",
      vietnamese:
  ...
  adminPages: {
    ...
    dashboard: {
      ragStatus: {
        summaryHealthy: "All checks passed. You can ingest documents and generate questions.",
        summaryUnhealthy: "Some checks did not pass — see the details below.",
        checkConnection: "RAG connectivity",
        checkConfig: "RAG configuration",
        checkVectorDb: "Vector database",
        msgConnection: "RAG service responded in {{ms}}ms",
        msgConfig: "Configuration valid (API key, database URL, embedding dimension)",
        msgVectorDb: "PostgreSQL pgvector operating normally",
        msgConnectionFail: "RAG service returned an error (HTTP {{code}})",
        msgConnectionDown: "RAG service could not be reached",
        msgNotChecked: "Not checked because the RAG service is unreachable",
        refreshTitle: "Refresh status",
        loading: "Loading status…",
        unreachable: "Could not reach the RAG service.",
      ...
      questionTypeChart: {
        ...
        subtitle: "Share of questions by category",
        technical: "Technical",
        behavioral: "Behavioral",
        situational: "Situational",
        cultural: "Cultural fit",
        noData: "No data yet",
        tooltipQuestions: "{{n}} questions ({{pct}}%)",
        totalQuestions: "Total questions",
        leadership: "Leadership",
      },
      platformChart: {
        title: "Question set statistics",
        subtitle: "Distribution by difficulty and activity",
        questionSets: "Question sets",
        easy: "Easy",
        medium: "Medium",
        hard: "Hard",
        totalQuestions: "Total questions",
        totalAttempts: "Practice attempts",
        quantity: "Quantity",
        unitSets: "sets",
      ...
      secondaryStats: {
        ...
        cards: [
          ...
          { label: "Export success rate", value: "99.6%", sub: "Excel pipeline · last 7 days" },
        ],
      },
      weeklyOverview: {
      ...
      alertsPanel: {
        ...
        ragDown: "RAG service unavailable",
        ragDownDesc: "Document ingestion and question generation may fail until it recovers",
      },
      generationActivity: {
    ...
    marketplace: {
      ...
      subtext: "Published sets — Practice vs Hiring tags, pin featured, track practice stats.",
    ...
    users: {
      ...
      subscription: {
        ...
        usageEmpty: "No usage counters in this period yet.",
        usageLoadError: "Could not load usage.",
        usageColType: "Type",
        usageColUsed: "Used",
        usageColExtra: "Pack extra",
        usageHrGenerateWindow: "Generate set / JD-fit (window)",
        usageHrGeneratePeriod: "Generate set (period total)",
        usageHrQuestionRegen: "Question regen / plan",
        usageHrAskAi: "Ask-AI",
    ...
    feedbacks: {
      ...
      updateError: "Could not update feedback. Please try again.",
    ...
    aiConfigPage: {
      ...
      subtext: "Read-only view of the AI runtime. Settings are managed outside the product.",
    ...
    plansPage: {
      ...
      editor: {
        ...
        askAiLabel: "Ask-AI per period",
        cooldownLabel: "Generate window length",
        generatePerWindowLabel: "Generate set / JD-fit per window",
        questionRegenPerPlanLabel: "Question regen per plan",
        regenerateLabel: "Plan refine per draft",
        freeVisibleLabel: "Free visible % (legacy)",
        canExportLabel: "Allow Excel export",
        generateUnlimitedLabel: "Unlimited generate",
        saveBtn: "Save plan",
        ...
        hintQuestionRegen: "Per-question regenerations per plan. Set 0 for unlimited.",
        hintRegenerate: "Plan refine runs allowed per draft.",
        hintFreeVisible: "Legacy — Free already practices the full set; unused for hiding questions (BE keeps 100).",
    ...
    settings: {
      ...
      general: {
        ...
        minQuestionsLabel: "Minimum questions for HR to publish a set to the marketplace",
      maxPinnedLabel: "Maximum sets pinned on the Marketplace",
      trendingLabel: "Practice attempts needed to show the Trending badge",
      saveFailed: "Could not save settings",
      loadFailed: "Could not load settings",
      retry: "Retry",
      systemSection: "System configuration",
      minQuestionsHint: "Applies at runtime, no redeploy needed. Set 1 to make testing easier.",
      maxPinnedHint: "SCRUM-404: admins cannot pin more than this at once.",
      trendingHint: "Candidates see the Trending badge when AttemptCount >= this threshold.",
      saving: "Saving…",
      antiCheatSection: "Anti-cheat",
        antiCheatEnabled: "Enable platform-wide anti-cheat",
      ...
      permissions: {
        ...
        features: [
          ...
          { label: "Export Sessions", desc: "Export questions to Excel" },
  ...
  jobseekerCoachPage: {
    ...
    stepsLockedAfterRoadmap:
      "Roadmap started — earlier steps are locked. Use “New Coach run” to start over.",
    ...
    target: "Target",
    status: "Status",
    statuses: { pending: "Not Started", in_progress: "In Progress", done: "Done" },
    ...
    marketplaceHint: "Want company hiring assessments? Open Jobs.",
    ...
    noCompareData: "No comparison data yet",
    statsZeroHint: "Complete a test to update your progress.",
    ...
    phaseContextTitle: "Context",
    phaseContextDesc: "Review CV analysis and confirm your goals.",
    phaseDiagnosticTitle: "Diagnostic",
    phaseDiagnosticDesc: "AI generates a competency knowledge check.",
    phaseReportTitle: "Competency report",
    phaseReportDesc: "See readiness, strengths, and skill gaps.",
    phaseRoadmapTitle: "Practice roadmap",
    phaseRoadmapDesc: "Follow targeted drills per skill gap.",
    phaseReassessTitle: "Re-evaluate",
    phaseReassessDesc: "Measure progress and update your report.",
    contextTitle: "Confirm your coaching goals",
    contextSubtitle:
      "Pick role and levels so we generate the right diagnostic blueprint — not your final competency level.",
    cvAnalysisHint: "CV analysis",
    cvPrepDisclaimer:
      "CV analysis only prepares the diagnostic. Your real competency level is determined after you take the test.",
    ...
    selfLevelLabel: "Self-assessed level (for blueprint)",
    targetLevelLabel: "Target practice level",
    levelPrepHint:
      "These levels only choose difficulty/framework for question generation — not Achieved Level after scoring.",
    levelOrderHint: "Target level must be equal to or higher than your self-assessed level.",
    goalFormIncomplete: "Enter a target role and a valid level.",
    ...
    contextSaved: "Goals saved — you can start the diagnostic.",
    contextSaveFailed: "Could not save coaching context.",
    confirmContextFirst: "Confirm your goals before starting the diagnostic.",
    ...
    overallDelta: "{{delta}} vs previous",
    gapPoints: "{{points}} pts to target",
    bandStrength: "Strength",
    bandNeedsImprovement: "Needs work",
    bandCritical: "Critical gap",
    reportTargetLabel: "Target level",
    reportSkillsSummaryLabel: "Skills",
    reportSkillsAtTarget: "{{at}} / {{total}} at target",
    reportSkillsBelow: "{{count}} still below target",
    reportAllZeroHint:
      "Scores are based on your latest diagnostic — zero means those skills were not demonstrated yet, not a system error.",
    reportSkillGapsTitle: "Skill progress",
    strengthsTitle: "Strengths",
    criticalGapsTitle: "Critical gaps",
    noStrengths: "No strengths flagged yet.",
    noCriticalGaps: "No critical gaps — great job!",
    roadmapsTitle: "Skill roadmaps",
    ...
    roadmapStartFailed: "Could not start roadmap.",
    roadmapPreviewTitle: "Preview your roadmap",
    roadmapPreviewSubtitle: "Toggle topics per skill — accept only when at least one skill remains.",
    roadmapPreviewSummary: "Will learn {{skills}} skills / {{topics}} topics",
    roadmapPreviewTopicCount: "{{count}} topics",
    roadmapPreviewPriorityLine: "{{priority}} priority · {{score}}",
    roadmapAcceptBarSummary: "{{skills}} skills · {{topics}} topics",
    roadmapShowMore: "Show more",
    roadmapShowLess: "Show less",
    roadmapHeaderProgress: "{{done}}/{{total}}",
    priorityHighLabel: "High",
    priorityMediumLabel: "Medium",
    priorityLowLabel: "Low",
    journeyCurrentBadge: "Practice",
    roadmapSkillFromCv: "From CV",
    roadmapSkillOutsideCv: "Outside CV",
    roadmapAcceptCta: "Accept roadmap",
    roadmapAcceptMinOneSkill: "Keep at least one skill with a learning topic.",
    roadmapAccepted: "Roadmap accepted — you can start drilling.",
    ...
    roadmapStatusSuggested: "Suggested",
    roadmapStatusActive: "Active",
    roadmapStatusCompleted: "Completed",
    cancelGeneration: "Cancel generation",
    cancelled: "Generation cancelled — you can retry.",
    editGoal: "Edit goals",
    ...
    readinessTowardTarget: "Technical readiness toward target level",
    achievedLevelLabel: "Achieved level",
    targetReadinessReady: "READY",
    targetReadinessNotReady: "NOT READY",
    nextLevelTitle: "Ready for {{current}} — continue toward {{next}}?",
    nextLevelBody:
      "You met readiness for {{current}}. Confirm to set the target to {{next}} and run a new diagnostic (current report/roadmaps will be replaced).",
    nextLevelCta: "Continue toward {{next}}",
    nextLevelConfirm:
      "Change Target Level to {{next}} and start a new diagnostic? The current report/roadmaps will be replaced (history is kept).",
    nextLevelConfirmYes: "Confirm & run diagnostic",
    nextLevelConfirmNo: "Cancel",
    nextLevelUnavailable: "Cannot promote yet — no framework for the next level in the catalog.",
    nextLevelStarted: "Target updated to {{next}} — generating diagnostic…",
    nextLevelFailed: "Could not move to the next level. Try again later.",
    estimatedBandReference: "Estimated band (reference only)",
    reportWillBeReplaced:
      "Changing goals and running a new diagnostic will replace the current report/roadmaps (history is kept).",
    contextConfirmedBadge: "Goals confirmed",
    readinessLabel: "Readiness",
    readinessEmpty: "No report yet — finish a diagnostic first.",
    ...
    frameworkUnsupportedHint: "This role is outside the supported software-engineering domain.",
    frameworkEmpty: "Target role is not confirmed yet.",
    marketplaceLinkTitle: "Marketplace",
    marketplaceLinkDesc: "Take hiring assessments from open roles.",
    marketplaceSectionTitle: "Recommended practice",
    marketplaceSectionSubtitle: "Company-published sets matching your roadmap skills — practice here.",
    marketplaceSeeAll: "See all",
    marketplaceLoadFailed: "Could not load Marketplace sets.",
    marketplaceEmpty: "No matching Marketplace sets yet.",
    marketplaceRetry: "Retry",
    upgradeDesc: "Upgrade to Premium for full AI Coach.",
    reportEmptyTitle: "No report yet",
    reportEmptyBody: "Complete a diagnostic to see readiness and skill gaps.",
    roadmapEmptyTitle: "No roadmaps yet",
    roadmapEmptyBody: "Roadmaps appear after your diagnostic is scored.",
    scoringCompetencyTitle: "Scoring competency…",
    scoringCompetencyBody:
      "Your practice session is done. Coach is computing readiness and building roadmaps — stay on this page a few seconds.",
    rescoreFailed: "Could not rescore the competency report. Retake the diagnostic or try again later.",
    reassessEmptyTitle: "Not ready to re-assess",
    reassessEmptyBody: "Finish roadmap drill items to unlock the re-assessment gate.",
    ...
    analysisEmpty: "No CV summary yet. Upload a CV or add a tech stack.",
    ...
    levelRuleLabel: "Achieved level",
    radarCurrent: "Current",
    radarTarget: "Target",
    openRoadmapDetail: "Open roadmap",
    gateLocked: "Locked",
    sourceLink: "Source",
    prerequisitesLabel: "Prerequisites",
    nextTopicsLabel: "Next",
    journeyProgress: "{{done}}/{{total}} topics · {{percent}}%",
    currentStep: "In progress",
    gateNode: "Re-assessment gate",
  },
  ...
  jobseekerSetDetailPage: {
    ...
    interviewBriefingLabel: "Interview Simulation",
    matchCv: "CV Match",
    interviewPlanTitle: "Interview Structure",
    interviewPlanSub: "Questions distributed by topic",
    skillsTitle: "Key Skills",
    skillsCoverage: "questions",
    readinessPanelTitle: "Interview Readiness",
    previousPerformanceTitle: "Previous Attempt",
    lastScore: "Last Score",
    completedOn: "Completed on {{date}}",
    activeSessionBadge: "In Progress",
    activeSessionHint: "You have an unfinished session.",
    startOverLabel: "Start Over",
    recommendedTarget: "Recommended target: ≥ 75 / 100",
    platformAttempts: "platform attempts",
    suggestedTargetLabel: "Suggested Target",
    lockedQuestionsNote: "{{count}} Premium question(s) hidden on Free plan.",
    ...
    categoryDescs: {
      technical: "Technical knowledge & programming",
      behavioral: "Experience & soft skills",
      situational: "Real-world scenario analysis",
      problemSolving: "Debugging & solution optimization",
      systemDesign: "System design & architecture",
      other: "Other interview questions",
    },
    beforeYouStartTitle: "Before You Start",
    beforeItems: {
      timeAdvice: "Allocate ~{{time}} to finish",
      answerAuthentically: "Answer as in a real interview",
      aiEvaluation: "AI evaluates after you complete",
      progressSaved: "Progress is saved automatically",
      premiumLocked: "{{count}} questions require Premium to unlock",
    },
  },
  ...
  antiCheat: {
    ...
    setupDescription:
      "Integrity monitoring runs locally in your browser. Webcam frames are not uploaded.",
    deviceCheckSubtitle: "Check your devices before starting the interview",
    setupPanelTitle: "Pre-interview check",
    setupPanelIntro: "Make sure your camera and monitoring system are ready before you begin.",
    privacyTitle: "Privacy",
    privacyBody: "Camera analysis runs in your browser. Frames are not uploaded.",
    cameraActive: "Camera active",
    cameraReadyFooter: "Camera ready",
    faceGuideHint: "Keep your face in the frame",
    phoneModelLoading: "Loading model…",
    faceHelper: "Make sure your face is clearly visible in the frame.",
    multiHelper: "Only one candidate may appear on camera.",
    cameraHelper: "Please check camera access permissions.",
    systemReadyTitle: "System ready",
    systemReadyBody: "You can start the interview.",
    cannotStartTitle: "Cannot start yet",
    completeChecksHint: "Complete the checks to start",
    checksProgress: "{{ready}}/{{total}} checks complete",
    camera: "Camera",
    face: "Face",
    singleCandidate: "Single candidate",
    phoneModel: "Phone detection",
    ...
    statusFailed: "Failed",
    statusMultipleNone: "Multiple people detected",
    statusNotDetected: "Face not detected",
    ...
    retry: "Retry",
    monitoringActive: "Integrity monitoring active",
    integrityStartFailed: "Could not start integrity monitoring",
    cameraDisconnected: "Camera disconnected — integrity signal recorded",
    warningsCount: "Warnings {{current}}/{{max}}",
    ...
    terminatedBody:
      "Your interview session has been ended because multiple interview integrity violations were detected.",
    violationsDetected: "{{count}} integrity violations detected",
    violationHistory: "Violation history",
    terminatedFooter: "For interview fairness and integrity, this session can no longer continue.",
    returnDashboard: "Return to dashboard",
    events: {
      NO_FACE: {
        name: "Candidate not visible",
        description: "You were not visible in the camera for an extended period.",
      },
      MULTIPLE_FACE: {
        name: "Multiple people detected",
        description: "More than one person was visible in the camera.",
      },
      PHONE_DETECTED: {
        name: "Mobile phone detected",
        description: "A mobile phone was detected in the camera.",
      },
      LOOKING_AWAY: {
        name: "Prolonged looking away",
        description: "Prolonged head movement away from the interview was detected.",
      },
      TAB_SWITCH: {
        name: "Left interview tab",
        description: "You left the active interview tab.",
      },
      WINDOW_FOCUS_LOST: {
        name: "Interview window lost focus",
        description: "The interview window lost focus.",
      },
      FULLSCREEN_EXIT: {
        name: "Exited fullscreen",
        description: "You exited fullscreen mode during the interview.",
      },
      CAMERA_DISABLED: {
        name: "Camera disabled",
        description: "The interview camera was disabled or disconnected.",
      },
    },
  },
  ...
  jobseekerPracticePage: {
    ...
    exitConfirm: "Are you sure you want to exit? This session will be abandoned.",
    exitConfirmTitle: "Exit practice?",
    exitConfirmMessage:
      "Confirming exit abandons this session — progress will not be kept. If you only lose network or refresh the page (without confirming exit), you can still come back and continue the in-progress session.",
    exitConfirmBtn: "Exit & abandon",
    exitConfirmTitleHiring: "Exit assessment?",
    exitConfirmMessageHiring:
      "Confirming exit abandons this assessment session — progress will not be kept. If you only lose network or refresh the page (without confirming exit), you can still come back and continue the in-progress session.",
    exitConfirmBtnHiring: "Exit & abandon assessment",
    exitCancelBtn: "Stay",
    ...
    antiCheatExitTitle: "Cannot leave temporarily",
    antiCheatExitMessage:
      "Anti-cheat is enabled for this session. The timer does not pause and you cannot leave mid-session. Continue answering or submit.",
  ...
  jobseekerFeedbackPage: {
    ...
    // SCRUM-447: next-step guidance after Coach session
    backToCoach: "Back to AI Coach",
    coachNextTitle: "Next step in AI Coach",
    ...
    freemium: {
      ...
      upsellBody: "Free includes overall score + 1 sample AI review. Premium unlocks every score, skill gap, and a personal learning roadmap.",
      upsellCta: "Unlock full AI Feedback",
      lockedHint: "This includes score and rewrite tips. Upgrade to Premium for AI feedback on every question.",
  ...
  jobseekerDashboardPage: {
    streakCard: {
      title: "Your streak",
      nextMilestone: "{{days}} days to go → {{label}}",
      milestoneDays: "{{n}} days",
      daysInARow: "days in a row",
      thisWeek: "This week",
      weekProgress: "{{n}}/7 days",
      thisMonth: "This month",
      monthUnit: "days",
      ...
      motivation0: "Let's get going! 🔥",
      motivation1: "Good start! ⚡",
      motivation2: "On a roll! 🚀",
      motivation3: "Excellent! Keep it up! 🔥",
      motivation4: "Legendary! 🏆",
    },
    welcomeTemplate: "{{greeting}}, {{name}} 👋",
    greetingMorning: "Good morning",
    greetingAfternoon: "Good afternoon",
  ...
  jobseekerProfilePage: {
    ...
    cv: {
      ...
      notItDomain:
        "We only accept IT/software engineering CVs. Please upload a technical resume.",
  ...
  hrRecommendationsPage: {
    ...
    displayPrefsTitle: "List display preferences",
    displayPrefsHint: "Adjust filters/sort below, then save as your default for this page.",
    displayPrefsMinScore: "Minimum score",
    displayPrefsSort: "Sort",
    displayPrefsHideDismissed: "Hide dismissed on All tab",
    displayPrefsSave: "Save as default",
    displayPrefsSaveSuccess: "Display preferences saved.",
    displayPrefsSaveFailed: "Couldn't save preferences. Try again.",
    filters: {
      allStatuses: "All Statuses",
      statusNew: "New",
      statusViewed: "Viewed",
      ...
      allScores: "All levels",
      score70plus: "Fair & above",
      score80plus: "Good & above",
      score90plus: "Excellent",
    ...
    card: {
      ...
      unread: "Unread",
      fitPercent: "Fit",
      /** SCRUM-430: Fit tied to question set / JD */
      fitAgainst: "Match for: {{title}}",
    },
    invite: {
    ...
    compareNoSelection: "Pick 2–3 candidates from the list to compare them side by side.",
    compareMax: "You can compare at most 3 candidates.",
    fit: {
      title: "CV–JD fit",
      /** SCRUM-430 */
      fitAgainstSet: "For question set: {{title}}",
      matched: "Matched",
    ...
    prevPage: "Previous",
    nextPage: "Next",
    hiddenDismissedSuffix: "hidden (Dismissed)",
  },
  ...
  hrTalentPage: {
    heading: "Talent pool",
    subtext: "Candidates who took your Practice or Hiring question sets (with recruiter visibility on).",
    ...
    allStatuses: "All",
    allQuestionSets: "All",
    questionSetFilter: "Question set",
    minScore: "Min score",
    loading: "Loading talent pool…",
    loadFailed: "Could not load the talent pool.",
    retryBtn: "Retry",
    emptyTitle: "No sessions yet",
    emptySubtext: "When candidates take your Practice or Hiring sets, they appear here.",
    candidate: "Candidate",
    attempt: "Attempt",
    questionSet: "Question set",
    score: "Score",
    ...
    date: "Date",
    actions: "Actions",
    scorePendingTitle: "Not scored yet",
    dateIncompleteTitle: "Not completed",
  ...
  jobseekerSettingsPage: {
    ...
    billing: {
      ...
      loadFailed: "Failed to load billing information.",
      // Current plan
      ...
      freePlan: "Free Plan",
      premiumPlan: "Premium",
      freeDesc: "Free: practice every question in a set. Only detailed AI feedback is limited (overall score + 1 sample).",
      ...
      renewalCancelled: "Renewal Date (auto-renew cancelled)",
      ...
      freeFeatures: [
        "Practice every question in each set",
        "5 practice sessions per month",
        "Overall score + 1 sample AI review",
        "10 sessions history",
      ...
      premiumFeatures: [
        ...
        "Detailed AI feedback on every question + skill gap",
      ...
      questionAccessLabel: "Question sets",
      questionAccessFullValue: "All questions",
      scorecardLabel: "HR Scorecard Sharing",
      basicLevel: "Basic (1 sample)",
      advancedLevel: "Advanced",
      lockedStatus: "Locked",
      unlockedStatus: "Unlocked",
      unlimitedLabel: "Unlimited",
      perSet: "visible per set",
      upgradeHint: "Upgrade for full AI feedback and other Premium features.",
      // Payment history
  ...
  reviewPage: {
    ...
    paginationQuestions: "Question {{from}}–{{to}} / {{total}} questions",
    missingQuestionSetId: "Missing questionSetId — can't {{action}}.",
    actionSaveOrder: "save the order",
    actionSaveEdit: "save the edit",
    actionDelete: "delete",
    actionAddQuestion: "add a question",
    actionSaveTimeLimit: "save the time limit",
    actionSaveRecSettings: "save the recommendation settings",
    ...
    statusPublished: "Published",
    liveFilterAll: "All",
    liveFilterLive: "On marketplace",
    liveFilterHidden: "Hidden",
    ...
    editLockedTitle: "Question set is published",
    editLockedBody: "Unpublish to edit, delete, or reorder questions.",
    setInfoTitle: "Question set details",
    setInfoStatus: "Status",
    setInfoQuestions: "Questions",
    setInfoTimeLimit: "Time limit",
    setInfoScore: "Suggested score",
    viewFullJd: "View full",
    collapseJd: "Collapse",
    ...
    recSettingsTitle: "Potential candidate recommendations",
    recSettingsHint: "When a Premium candidate finishes practice above your score threshold, the system suggests their profile. You can change this even after publishing.",
    recSettingsEnable: "Auto-recommend candidates who meet the threshold",
    recSettingsMinScore: "Minimum score (50–95)",
    recSettingsSave: "Save settings",
    recSettingsSaveSuccess: "Recommendation settings saved.",
    recSettingsSaveFailed: "Couldn't save recommendation settings. Please try again.",
    recSettingsLabelOn: "Recommend ≥ {{score}}",
    recSettingsLabelOff: "Auto-recommend off",
    ...
    generatingQuestionsSubtext:
      "Questions will appear automatically when ready. Please wait.",
    collapseDetails: "Collapse details",
    codeAnswerBadge: "Code / answer",
    sampleAnswerBadge: "Sample answer",
    rationaleHint: "(why ask)",
    noExtraDetails: "No additional details.",
    scoringRubricLabel: "Scoring rubric",
    toasts: {
      saveOrderFailed: "Could not save question order. Please try again.",
      editSuccess: "Question updated successfully.",
      editFailed: "Could not save edits. Please try again.",
      deleteSuccess: "Question deleted.",
      deleteFailed: "Could not delete the question. Please try again.",
      addSuccess: "Question added successfully.",
      addFailed: "Could not add the question. Please try again.",
    },
    questionActions: {
      edit: "Edit",
      delete: "Delete",
    ...
    questionCard: {
      ...
      /** Names the domain a question belongs to, so it is visible per question
       *  rather than implied by the set's role. */
      domainBadge: "Domain",
      focusBadge: "Focus",
    },
    unsavedDialog: {
    ...
    jdViewer: {
      ...
      empty: "This set has no JD yet. Attach one below (JD fit review) to view the full text.",
      collapse: "Collapse",
      expand: "Show JD content",
      missingBadge: "Missing",
      stats: "{{words}} words · {{lines}} lines",
      fromFile: "From file",
      viewParsed: "Parsed content from file",
    },
    jdFit: {
      title: "JD fit review",
      ...
      stale: "The question set or JD has changed since this review. Click Review again for a fresh assessment (uses 1 create/JD-review credit per 24h).",
  ...
  hrDashboardPage: {
    ...
    recentSessions: {
      ...
      deleteFailed: "Could not delete session. Please try again.",
      deleteModal: {
        title: "Confirm delete",
        subtitle: "This action cannot be undone",
  ...
  studioPage: {
    ...
    /** SCRUM-431: first-time yellow guide on side columns */
    guide: {
      stepSources: "Step 1 · Enter JD",
      stepSettings: "Step 2 · Configure",
      dismiss: "Got it",
      hint: "Fill both columns, then click Create Plan. Side panels will collapse to give the plan more space.",
    },
    steps: {
      jd: "Job Description",
      plan: "Create Plan",
    ...
    aria: {
      ...
      expandSource: "View input sources",
      expandSetting: "View configuration",
      collapseSource: "Collapse data sources",
      collapseSetting: "Collapse settings",
      viewSources: "View input sources",
    ...
    published: "Published",
    publish: "Publish",
    publishReadiness: "{{ready}}/{{total}} questions created",
    publishReviewNeeded: "{{count}} suggested for review",
    publishReviewConfirmTitle: "Suggested review before publish",
    publishReviewConfirmMessage: "{{count}} question(s) are suggested for review (content may not match code). Publish anyway?",
    publishReviewConfirm: "Publish anyway",
    publishedReadyHint: "This set is ready for candidates.",
    ...
    settings: {
      ...
      planPending: "Plan pending approval",
      locked: "Locked",
      lockedTitle: "Locked — a plan exists. Click New Set to edit again",
      basicsFrozenHint: "Question count / duration / difficulty are edited on the Plan.",
      sectionPlan: "Basic Configuration",
      sectionLanguagePrefs: "Language & options",
      sectionTypes: "Question Types",
      duration: "Duration",
      questionCount: "Question Count",
      difficulty: "Difficulty",
      easyDesc: "Easy — basic",
      ...
      typeTechnical: "Technical",
      typeDesign: "System Design",
      typeProblem: "Problem Solving",
      typeBehavioral: "Behavioral",
      typeSituational: "Situational",
      sourcesExpand: "View sources",
      sourcesCollapse: "Hide sources",
      ...
      formatStructured: "Structured Interview Kit",
      formatSimple: "Simple List",
      formatTechnical: "Technical Deep Dive",
      languageLabel: "Question Language",
      langOptionVietnamese: "Vietnamese",
      langOptionEnglish: "English",
      contentModeLabel: "Question content mode",
      contentModeTheory: "Theory only",
      contentModeCode: "Code only",
      contentModeMixed: "Code and theory",
      ...
      unitMin: "min",
      unitQuestions: "questions",
      sectionFocus: "Focus & distribution (HR)",
      ...
      config: {
        ...
        distributionValid: "Valid distribution · {{count}}/{{total}} · {{pct}}%",
        distributionSyncedHint: "Distribution scaled to the new question count (percentages kept).",
        ...
        configAppliedSuccess: "HR configuration saved.",
        basicConfigDraftHint: "Changes are draft — saved when you create a plan (or when you change difficulty on the plan).",
        configInvalidHint: "Complete frame + distribution + focus (~100% sum) then Apply to plan.",
        ...
        planConfigTitle: "Interview configuration",
        planConfigSubtitle: "Edit question count, duration, difficulty, distribution, focus, and styles on the plan.",
        planReviewTitle: "Plan proposal (IT)",
        planReviewSubtitle:
          "Edit Focus, difficulty, distribution, styles, coding — Apply (or Continue to preview if unchanged) to open Question preview.",
      ...
      noFocusConfigured: "Not configured — use AI recommend + Apply, or pick types below.",
      aiConfig: {
        title: "AI configuration recommendation",
        subtitle: "Analyze JD + RAG to suggest focus areas and question mix. You can edit before saving.",
        jobProfileTitle: "Job profile",
        unknown: "Unknown",
        recommendBtn: "AI recommend",
        recommending: "Analyzing…",
        applyBtn: "Apply recommendation",
        applying: "Applying…",
        draftTitle: "AI draft (not saved yet)",
        applyHint: "Apply writes to HR settings — you can still edit before generating a plan.",
        emptyDraft: "No recommendation yet. Analyze JD first, then click AI recommend.",
      },
    },
    sources: {
      ...
      optional: "Optional",
      sampleJd: "Sample JD",
      samplePickHint: "Pick a sample JD",
      sampleModalHint: "Choose a sample that matches the role you're hiring for",
      sampleRoleLabel: "Role",
      sampleRoleSearch: "Search roles…",
      samplePreviewLabel: "Job description preview",
      sampleCopiedToast: "JD copied",
      sampleNoRoles: "No roles match your search.",
      pasteMode: "Paste",
      ...
      uploading: "Uploading…",
      locked: "Locked",
      lockedTitle: "Locked — a plan exists. Click New Set to edit Sources",
      ...
      viewMore: "View more",
      viewLess: "View less",
      jobProfileTitle: "Detected job profile",
      autoDetect: "Auto-detected",
      positionLabel: "Position",
      positionPlaceholder: "e.g. Senior .NET Backend Engineer",
      positionHint: "Extracted from the JD — you can edit before creating a plan.",
      positionRequiredHint: "Enter and save a position to create an interview plan.",
      positionSave: "Save position",
      roleLabel: "Role",
      rolePlaceholder: "e.g. Backend Developer",
      levelLabel: "Level",
      levelPlaceholder: "Select level",
      levelRequiredHint: "Select and save a level before creating a plan.",
      metadataSave: "Save confirmation",
      metadataHint: "Confirm position + level (and skills if needed) before creating a plan.",
      metadataDirtyHint: "Unsaved changes — click Save confirmation.",
      metadataSaved: "JD metadata saved.",
      aiSuggestedLevel: "AI suggested this level",
      aiSuggestedLevelHint: "AI suggested: {{level}}",
      skillsEditHint: "Add, edit, or remove skills if AI missed or misdetected any.",
      skillsAddPlaceholder: "Add a skill…",
      skillsEditTag: "Edit skill",
      skillsRemove: "Remove skill",
      skillsMaxHint: "Maximum 20 skills.",
      colRole: "ROLE",
      colLevel: "LEVEL",
      colLang: "LANGUAGE",
      ...
      colSkills: "SKILLS",
      colSummary: "SUMMARY",
      colResponsibilities: "RESPONSIBILITIES",
      ...
      jdInvalidType: "Only PDF, DOCX, TXT, JPG and PNG files are supported.",
      jdFileTooLarge: "JD file exceeds the 20 MB limit.",
      docInvalidType: "Only PDF, DOCX and TXT files are supported.",
      docFileTooLarge: "Document file exceeds the 20 MB limit.",
      sourceOriginHr: "HR",
      sourceOriginAdmin: "System",
      sourceOriginJd: "JD",
      sourceOriginLlm: "LLM",
      sourcesAdminAutoHint: "Admin (system) documents are auto-retrieved by RAG when generating plans/questions — no manual attach needed.",
      suggestionsLoading: "Suggesting documents matching the JD…",
      suggestionsTitle: "{{count}} Knowledge documents match this JD",
      attachOne: "Attach",
      attachAllSuggestions: "Attach all ({{count}})",
      uploadDocType: "Type when uploading",
    },
    chat: {
      tabPlan: "Plan",
      tabAi: "AI Assistant",
      ...
      flowStep1: "Enter JD",
      flowStep2: "Analyze",
      flowStep3: "Create Plan",
      jdReadyTitle: "JD Ready",
      jdReadySub: "Click Create Plan to let AI generate a detailed structure.",
      positionMissingHint: "Confirm Position and Level in Sources before creating a plan.",
      ...
      planInterviewLabel: "Interview plan",
      planSummaryTitle: "Plan summary",
      planSummaryQuestions: "Questions",
      planSummaryDuration: "Duration",
      planSummaryDifficulty: "Difficulty",
      planSummaryFocus: "Focus areas",
      planSummaryDistribution: "Question distribution",
      planSummaryStyles: "Styles",
      planSummaryStylesSelected: "{{count}} selected",
      planSummaryCoverage: "Coverage",
      planSummaryCoverageSkills: "{{count}} skills",
      planSummarySources: "Sources",
      planSummarySourcesCount: "{{count}} sources",
      planReady: "Plan ready to approve",
      planNotReady: "Plan is incomplete",
      planMissingFocus: "Focus areas not ~100%",
      ...
      planProgress: "Plan creation progress",
      questionsGeneratedCount: "{{done}}/{{total}} questions",
      ...
      sourceRoleLlm: "Reasoning",
      reasonInferredFromJd: "Inferred from the instruction / JD",
      reasonRubricFromLlm: "Scoring rubric — inferred by the LLM from skill / difficulty / sample",
      reasonSampleFromLlm: "Sample answer — added by the LLM when no Admin/JD chunk matched",
      sourceWhyAsked: "HR skill requirement",
      sourceTechnicalBody: "Standard technical reference",
      sourceLlmSupplement: "AI-synthesized supplement",
      sourceSectionAdminEmpty: "No Admin document linked to this question.",
      sourceSectionLlmEmpty: "No LLM supplement for this question.",
      missingAdminWarning: "No Admin KB",
      ...
      delete: "Delete",
      regenerate: "Regenerate",
      regenNoteTitle: "Regenerate question",
      regenNoteHint: "Optional note for AI — leave blank to regen from locked skill/focus/goal.",
      regenNotePlaceholder: "e.g. Make it harder, add a code-completion stub…",
      regenConfirm: "Regenerate",
      regenCancel: "Cancel",
      regenChipHarder: "Make it one level harder",
      regenChipMoreCode: "Add / clarify code stub",
      regenChipShorter: "Make it shorter",
      regenChipJd: "Stick closer to JD / slot skill",
      regenChipClarify: "Clarify the problem statement",
      regenGeneratingTitle: "Regenerating question…",
      regenGeneratingHint: "Queued in the background — you can close this dialog and keep working.",
      regeneratingBadge: "Regenerating…",
      regenQueuedToast: "Regenerating question #{{n}}…",
      regenDoneToast: "Question #{{n}} regenerated",
      regenFailedToast: "Failed to regenerate question #{{n}}",
      regenFailedShort: "Regeneration failed",
      regenStep1: "Reading JD & skill context…",
      regenStep2: "Drafting the new question…",
      regenStep3: "Attaching sources & rationale…",
      regenStepWait: "Still working — please wait…",
      confirmDelete: "Delete this question?",
      confirmDeleteTitle: "Delete question",
      confirmDeleteConfirm: "Delete",
      detailsToggle: "Sample answer & scoring rubric",
      missingSampleShort: "Missing sample answer",
      missingRubricShort: "Missing rubric",
      sourcesLabel: "Sources {{count}}",
      sourcesPanelTitle: "Document sources",
      mismatchWarning: "Question and code may not match",
      mismatchWarningHint: "Consider regenerating or editing the snippet.",
      addImage: "Add image",
      changeImage: "Change image",
      removeImage: "Remove image",
      moreActions: "More actions",
      ...
      reviewQuestionsTitle: "Questions",
      reviewCreated: "{{count}} questions created",
      reviewRagSources: "{{count}} RAG sources",
      reviewNeedsReview: "{{count}} suggested for review",
      reviewReady: "{{ready}}/{{total}} created",
      reviewFilterAll: "All {{count}}",
      reviewFilterNeedsReview: "Suggested review {{count}}",
      reviewPrev: "Previous",
      reviewNext: "Next",
      reviewOf: "Question {{current}} / {{total}}",
      reviewListToggle: "Question list",
      reviewNavHint: "Select a question to review",
      diagramHintTitle: "Diagram hint for HR",
      diagramHintSub: "Not AI-generated — suggests which diagram type to attach.",
      ...
      jdAnalyzedSub: "Finish the profile (left) and options (right), then create the interview plan.",
      planDifficultyHint: "Set overall difficulty for the plan before approving.",
      ...
      maxQuestionsTitle: "Maximum of 50 questions reached",
    },
    questionsTab: {
      title: "Questions ({{count}})",
      refreshStatus: "Refresh status",
      generatingAsync: "Generating questions (RAG async)…",
      jobStatus: "Job: {{status}}",
      runMeta: "Run {{id}}… • requested {{requested}}q",
      runMetaGenerated: " • generated {{generated}}",
      noErrorDetail: "No error details.",
      stillGeneratingHint:
        "Job is still Generating — RAG may not have called back yet. Refresh or check BE/RAG deploy.",
      emptyCompletedHint: "Run Completed but the list is empty — try Refresh or Generate again.",
      emptyNoQuestions: "No questions yet. Approve the plan, then Generate Interview Questions.",
      edit: "Edit",
      regenerate: "Regenerate",
      delete: "Delete",
      cancel: "Cancel",
    ...
    toasts: {
      ...
      generationStarted: "Started generating questions…",
      generationDone: "{{count}} questions created.",
      ...
      recommendConfigDone: "AI configuration recommendation ready.",
      recommendConfigApplied: "Recommendation applied to HR settings.",
      recommendConfigMissing: "No AI recommendation yet — click AI recommend first.",
      ...
      jdAnalyzeServerError: "The server is temporarily unavailable, so the job description could not be analyzed. Please try again later.",
      jdAnalyzeNetworkError: "Could not reach the server, so the job description could not be analyzed. Check your connection and try again.",
      positionRequired: "Position cannot be empty.",
      positionSaved: "Position saved.",
      positionSaveFailed: "Could not save position.",
      positionRequiredForPlan: "Confirm the job position before creating a plan.",
      seniorityRequired: "Level is invalid.",
      seniorityRequiredForPlan: "Confirm the seniority level before creating a plan.",
      metadataSaveFailed: "Could not save JD metadata.",
      metadataSaved: "JD metadata saved.",
