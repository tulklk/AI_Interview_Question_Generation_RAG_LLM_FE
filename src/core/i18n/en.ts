...
Candidates should be able to explain fullstack architecture, frontend-backend flow, API security, database optimization, and production error handling.`,
  ...
  jobseekerCoachPage: {
    ...
    frameworkPreviewNone: "No catalog match yet — Adaptive or unsupported may apply.",
    skillsFromSystemHint:
      "Skills to assess come from CV analysis and the framework/KB — the system picks them when you start the diagnostic; no manual entry.",
    ...
    reportSubtitle: "Readiness and skill gaps from your latest assessment.",
    overallReadiness: "Overall readiness",
    overallDelta: "{{delta}} vs previous",
    gapPoints: "Gap: {{points}} pts to target",
    ...
    roadmapKbInferred:
      "Warning: no roadmap KB yet — topics are inferred from framework/nodes, not SYSTEM retrieval.",
    roadmapKbSystemBadge: "System",
    roadmapKbInferredBadge: "Inferred",
