...
Ứng viên cần có khả năng giải thích kiến trúc fullstack, luồng frontend-backend, bảo mật API, tối ưu database và xử lý lỗi production.`,
  ...
  jobseekerPracticePage: {
    ...
    reviewConfirmMessage: "Bạn đã trả lời đủ {{count}} câu hỏi. Sau khi nộp bài, bạn sẽ không thể chỉnh sửa câu trả lời và AI có thể mất một chút thời gian để đánh giá. Bạn đã sẵn sàng nộp bài chưa?",
