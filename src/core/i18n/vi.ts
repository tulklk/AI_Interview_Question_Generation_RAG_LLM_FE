...
Ứng viên cần có khả năng giải thích kiến trúc fullstack, luồng frontend-backend, bảo mật API, tối ưu database và xử lý lỗi production.`,
  ...
  hrRecommendationsPage: {
    ...
    invite: {
      ...
      defaultMessage: "Chào {{name}}, chúng tôi rất ấn tượng với kết quả luyện tập \"{{title}}\" của bạn ({{score}}/100) và muốn mời bạn tham gia phỏng vấn. Bạn vui lòng phản hồi email hoặc số điện thoại để chúng tôi tiện liên hệ nhé. Cảm ơn bạn!",
      sendBtn: "Gửi lời mời",
      cancelBtn: "Hủy",
      sending: "Đang gửi…",
    },
