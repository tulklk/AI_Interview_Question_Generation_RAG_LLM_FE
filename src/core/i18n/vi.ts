...
Ứng viên cần có khả năng giải thích kiến trúc fullstack, luồng frontend-backend, bảo mật API, tối ưu database và xử lý lỗi production.`,
  ...
  jobseekerDashboardPage: {
    ...
    analyticsUnavailable: "Biểu đồ hiệu suất theo từng kỹ năng chưa khả dụng.",
    skillBreakdownTitle: "Phân tích kỹ năng",
    skillBreakdownUnavailable: "Phân tích điểm mạnh/điểm yếu theo từng kỹ năng chưa khả dụng — bạn có thể xem điểm từng phiên trong Lịch sử luyện tập.",
    aiRecommendationTitle: "Khuyến nghị AI",
    aiRecommendationEmpty: "Hoàn thành phiên luyện tập đầu tiên để nhận gợi ý ở đây.",
    aiRecommendationTemplate: "Bạn đã hoàn thành {{count}} phiên với điểm trung bình {{avg}}%. Tiếp tục luyện tập để nâng cao mức độ sẵn sàng phỏng vấn.",
    aiRecommendationNoScore: "Bạn đã hoàn thành {{count}} phiên. Tiếp tục luyện tập để nâng cao mức độ sẵn sàng phỏng vấn.",
