...
Ứng viên cần có khả năng giải thích kiến trúc fullstack, luồng frontend-backend, bảo mật API, tối ưu database và xử lý lỗi production.`,
  ...
  settingsPage: {
    ...
    subscription: {
      ...
      orderCreatedToast: "Đã tạo đơn thanh toán. Vui lòng chuyển khoản đúng nội dung.",
      ...
      paymentPanel: {
        ...
        waitingWebhook: "Đang chờ webhook xác nhận thanh toán...",
        orderCode: "Mã đơn",
        amount: "Số tiền",
        status: "Trạng thái",
  ...
  jobseekerPracticePage: {
    ...
    reviewConfirmMessage: "Sau khi nộp bài, bạn sẽ không thể chỉnh sửa câu trả lời và AI có thể mất một chút thời gian để đánh giá. Bạn đã sẵn sàng nộp bài chưa?",
    reviewConfirmBtn: "Nộp bài",
  ...
  studioPage: {
    ...
    toasts: {
      ...
      draftSaved: "Đã lưu draft.",
      draftSaveFailed: "Lưu draft thất bại.",
      publishNotFound: "Không tìm thấy bộ câu hỏi để publish. Thử lưu nháp lại.",
