...
Ứng viên cần có khả năng giải thích kiến trúc fullstack, luồng frontend-backend, bảo mật API, tối ưu database và xử lý lỗi production.`,
  ...
  settingsPage: {
    ...
    subscription: {
      ...
      downgradeSuccess: "Đã chuyển về gói Free.",
      ...
      backBtn: "Quay lại",
      cancelModalTitle: "Hạ về gói Free",
      cancelModalDesc: "Bạn sẽ mất ngay các tính năng Premium sau:",
      cancelWarnings: [
      ...
      cancelConfirmBtn: "Hạ về Free",
      cancellingLabel: "Đang hạ gói…",
      paymentPanel: {
