  ...
  settingsPage: {
    ...
    subscription: {
      ...
      usage: {
        ...
        premiumHint: "Gói Premium: tạo bộ và tạo lại câu hỏi không giới hạn.",
  ...
  adminPages: {
    ...
    plansPage: {
      ...
      editor: {
        ...
        hintCooldown: "Số giờ của một cửa sổ generate.",
        hintGeneratePerWindow: "Số lần sinh bộ câu hỏi / JD-fit thành công trong mỗi cửa sổ.",
        ...
        hintGenerateUnlimited: "Bỏ qua toàn bộ hạn mức generate của gói này.",
        unitTimes: "lượt",
        unitHours: "giờ",
      },
    },
