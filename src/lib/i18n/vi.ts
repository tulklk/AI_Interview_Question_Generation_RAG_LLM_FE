...
export const vi: Translations = {
  ...
  knowledgePage: {
    ...
    howItWorks: [
      { title: "Upload tài liệu", desc: "Tải lên JD, tài liệu kỹ thuật, hoặc tài liệu nội bộ định dạng PDF/DOCX." },
      { title: "Hệ thống xử lý", desc: "AI sẽ phân tích và lập chỉ mục nội dung tài liệu để dùng làm nguồn RAG." },
      { title: "Tạo câu hỏi thông minh", desc: "Khi generate câu hỏi, AI sẽ tham chiếu tài liệu để tạo câu hỏi chính xác và phù hợp hơn." },
    ],
  ...
  generationSessionPage: {
    notes: {
      ...
      focusSkills: "Kỹ năng / Chủ đề trọng tâm",
