...
export const vi: Translations = {
  ...
  resetPasswordPage: {
    ...
    backToLogin: "Quay lại đăng nhập",
    tokenInvalid: "Liên kết đặt lại không hợp lệ hoặc đã được sử dụng. Vui lòng yêu cầu liên kết mới.",
    tokenExpired: "Liên kết đặt lại đã hết hạn. Vui lòng yêu cầu liên kết mới.",
    passwordTooShort: "Mật khẩu phải có ít nhất 8 ký tự.",
    passwordMismatch: "Mật khẩu không khớp.",
    resetFailed: "Đặt lại mật khẩu thất bại. Vui lòng thử lại.",
    missingToken: "Không tìm thấy token đặt lại. Vui lòng dùng liên kết trong email.",
  },
