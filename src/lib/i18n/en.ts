export const en = {
  ...
  knowledgePage: {
    ...
    howItWorks: [
      { title: "Upload a document", desc: "Upload a JD, technical document, or internal document in PDF/DOCX format." },
      { title: "System processes it", desc: "AI will analyze and index the document content to use as a RAG source." },
      { title: "Generate smart questions", desc: "When generating questions, AI references the documents to create more accurate and relevant questions." },
    ],
  ...
  generationSessionPage: {
    notes: {
      ...
      focusSkills: "Focus Skills / Topics",
