...
export default function VerifyEmailPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      {/* ── Animated background (mirrors forgot-password page) ─────────────── */}
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-8 py-16">
        <div className="w-full max-w-sm mx-auto bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-white/60 dark:border-gray-700/50 shadow-xl shadow-violet-100/40 dark:shadow-none p-8">
          <Suspense>
            <VerifyEmailContent />
          </Suspense>
        </div>
