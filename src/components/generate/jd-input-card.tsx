    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
      ...
      <div className="relative">
        <textarea
          ...
          rows={8}
          className={cn(
            "w-full resize-none rounded-xl border bg-white px-4 py-3 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 transition-colors",
            isTooShort
