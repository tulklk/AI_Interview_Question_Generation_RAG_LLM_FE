...
export function FinalCtaSection() {
  ...
  return (
    <section className="relative bg-white/40 backdrop-blur-sm py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-gradient-to-br from-[#6c47ff] to-[#8b65ff] rounded-xl px-10 py-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <ScrollReveal animation="fade-up" delay={0} as="div" className="inline-flex items-center gap-2 bg-white/15 text-white text-xs font-semibold px-3.5 py-1.5 rounded-full mb-6">
              <Sparkles size={12} />
              {c.badge}
            </ScrollReveal>
