  ...
  return (
    <div className="w-full max-w-sm mx-auto animate-fade-up">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button className="flex items-center justify-center gap-2 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium py-2.5 rounded-lg transition-colors">
      ...
      <p className="text-center text-[11px] text-gray-400 mt-3 leading-relaxed">
        {lp.legal}{" "}
        <button className="underline hover:text-gray-600">{lp.terms}</button>
        {" "}&amp;{" "}
        <button className="underline hover:text-gray-600">{lp.privacyPolicy}</button>
      </p>
    </div>
  );
}
