...
export function BillingSection() {
  return (
    <div>
      ...
      <div className="bg-gradient-to-br from-[#6c47ff] to-[#8b65ff] rounded-2xl p-5 mb-5 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 rounded-full bg-white/5 translate-x-10 -translate-y-10" />
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-3">
            <div>
              <p className="text-white/70 text-xs font-medium mb-0.5">Current Plan</p>
              <p className="text-white text-2xl font-bold leading-none">Professional</p>
            </div>
          ...
          <p className="text-white text-xl font-bold mb-3">
            $49<span className="text-white/70 text-sm font-normal">/month</span>
          </p>
          ...
          <div className="flex gap-2">
            <button className="flex-1 bg-white text-[#6c47ff] text-sm font-semibold py-2 rounded-xl hover:bg-white/90 transition-colors">
              Upgrade Plan
            </button>
            <button className="flex-1 bg-white/20 text-white text-sm font-semibold py-2 rounded-xl hover:bg-white/30 transition-colors">
              Manage Plan
            </button>
          </div>
        </div>
      ...
      <div>
        <p className="text-sm font-semibold text-gray-700 mb-3">Billing History</p>
